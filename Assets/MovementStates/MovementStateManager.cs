...
public class MovementStateManager : MonoBehaviour
{
    ...
    private void Update()
    {
        // Calculate movement direction and update inputs
        GetDirection();
        ...
        // Pass input values to the Animator
    ...
    {
        // Get player input
        hzInput = Input.GetAxis("Horizontal"); // Assign horizontal input
        vInput = Input.GetAxis("Vertical");   // Assign vertical input
